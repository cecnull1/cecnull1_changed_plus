...
import static com.github.cecnull1.cecnull1_changed_plus.entity.ModEntities.A_ENTITY_ID;

@OnlyIn(Dist.CLIENT)
public class AEntityModel extends AdvancedHumanoidModel<AEntity> implements AdvancedHumanoidModelInterface<AEntity, AEntityModel> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	@SuppressWarnings("removal")
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Cecnull1_changed_plusKt.MODID, "form_"+A_ENTITY_ID), "main");
	...
	private final HumanoidAnimator<AEntity, AEntityModel> animator;

	public AEntityModel(ModelPart root) {
		super(root);
	...
	@Override
	public void prepareMobModel(AEntity p_102861_, float p_102862_, float p_102863_, float p_102864_) {
		this.prepareMobModel(animator, p_102861_, p_102862_, p_102863_, p_102864_);
	}

	public void setupHand(AEntity entity) {
		animator.setupHand();
	}

	@Override
	public void setupAnim(@NotNull AEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	@Override
	public HumanoidAnimator<AEntity, AEntityModel> getAnimator(AEntity entity) {
		return animator;
	}
}